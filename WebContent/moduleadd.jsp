...
<div class="container">
    ...
    <form action="moduleadd" method="post">
         <div class="form-group">
          <label for="nom">Nom :</label>
                <input type="text" class="form-control red-border white-text"name="nom" size="30" />
                  </div>
                 <div class="form-group">
          <label for="description">Description :</label>
                <input type="text"class="form-control red-border white-text" name="description" size="30" />
                  </div>
        </table>
        <p />
